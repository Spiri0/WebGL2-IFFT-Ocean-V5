...
export const ocean_builder_threaded = (function() {

	//7 because my tablet has 8 cores in the processor. One is always used by the maintread. 
	//Not using the 7 others for computationally intensive tasks would be a waste
  ...
  class _OceanChunkRebuilder_Threaded {
    constructor(params) {
      ...
      this.workerPool_ = new WorkerThreadPool(
        _NUM_WORKERS, 'src/ocean/ocean-builder-threaded-worker.js');
