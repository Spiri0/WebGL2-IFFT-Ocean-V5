...
class BasicController {
	...
	Init(params) {
		...
		this.acceleration = new THREE.Vector3(1, 0.25, 5000.0);
...
//		const ac = 3 * this.params_.camera.position.y;

//		document.getElementById("testfield20").value = ac + 2000;


//		this.acceleration = new THREE.Vector3(1, 0.25, ac);
