...
float spermute(float x){return floor(mod(((x*34.0)+1.0)*x, 289.0));} 
vec4 staylorInvSqrt(vec4 r){return 1.79284291400159 - 0.85373472095314 * r;} 
float staylorInvSqrt(float r){return 1.79284291400159 - 0.85373472095314 * r;} 
...
// Permutations 
i = mod(i, 289.0); 
float j0 = spermute( spermute( spermute( spermute(i.w) + i.z) + i.y) + i.x); 
vec4 j1 = spermute( spermute( spermute( spermute ( 
...
const int octaves = 3; 
float noise4(vec4 position, float frequency, float persistence ){
