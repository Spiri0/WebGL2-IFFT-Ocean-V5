...
export const quadtree = (function() {
	...
	class QuadTree {
		...
		_DetermineLOD(squaredDistance, lodBuckets){
			...
			return -1; //out-of-range distances
		}
		...
		Insert(pos) {
			...
			const minCellSize = this._params.min_node_size;
			const lodBuckets = this._LODBuckets(minRadius, numLayers);			
			this._Insert(this.root_, pos, lodBuckets.lodRadii, lodBuckets.lodBuckets, minCellSize);	
		}


		_Insert(child, pos, lodRadii, lodBuckets, minCellSize) {
